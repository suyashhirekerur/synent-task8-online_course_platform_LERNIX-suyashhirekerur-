    ...
    <>
      ...
      <Routes>
        ...
        <Route
          path="/account"
          element={
            isAuth ? <Account user={user} /> : <Login />
          }
        />
        ...
        <Route
          path="/lectures/:id"
          element={
            isAuth ? <Lecture user={user} /> : <Login />
          }
        />
        ...
        <Route
          path="/admin/course"
          element={
            isAuth ? <AdminCourses user={user} /> : <Login />
          }
        />
        <Route
          path="/admin/users"
          element={
            isAuth ? <AdminUsers user={user} /> : <Login />
          }
        />
      </Routes>
      <Footer />
